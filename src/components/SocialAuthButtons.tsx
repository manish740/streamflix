  ...
  return (
    <div className="space-y-3 w-full">
      ...
      <button
        ...
        className="w-full h-11 sm:h-12 px-4 rounded-xl bg-[#141414] hover:bg-zinc-800/90 active:bg-zinc-900 border border-zinc-700/80 hover:border-zinc-500 text-white font-medium text-sm transition-all duration-200 flex items-center justify-center gap-3 shadow-md hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed group relative select-none"
      >
